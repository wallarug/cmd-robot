...
elif os.path.exists("C:\Users\090014"):
...
if str(question_two) == "y":
    detect_value = raw_input("What do you want to detect? (button/pos/all)")
...
while debug_value == "y":
    ...
    if motor_a < 0 and motor_a > -256:
    #dir_y = input("DIRECTION:Enter what way you wish to go (Positive value = Forwards or Negative va = Backwards): ")replaced with negative integer acceptance
        dir_y = 2
        print "Going Backwards!"
##    if dir_y < 0:
##        dir_y = 2
##        print "Going Backwards!"
    elif motor_a > 0 and motor_a < 256:               
        dir_y = 1
