...
try:
    ...
    ######################################
        ...
        motor_a = convert_pwm(a)
        motor_b = convert_pwm(b)
    ...
    ####################################
        ...
        dir_y = ardruino_direction(y)
        if y < 0:
            motor_a = invert_motor(motor_a)
            motor_b = invert_motor(motor_b)
    ...
    ##########################################
        if question_two == "y":
            if motor_a != motor_a_prev:
                ...
                sendcommand(smotor_a,motor_b,dir_y)
